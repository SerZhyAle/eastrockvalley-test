...
dag = DAG(dag_id='Payments_s3_to_mysql',
          default_args=default_args,
          schedule_interval=schedule,
          description='PAYMENTS: read S3 CSV insert into RDS MySQL'
          )

s3_to_mysql_payments = S3ToSqlOperator(
    task_id='s3_to_mysql_payments',
    schema='staging',
    table='payments',
    ...
    aws_conn_id='s3_conn',
    column_list=["transactionid", "userid", "amount", "transactiondate", "type"],
    commit_every=0,
...
s3_to_mysql_payments >> delete_s3csv
